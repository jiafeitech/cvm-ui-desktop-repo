...
cd $BASE_DIR/repo
dpkg-scanpackages --arch amd64 ./pool/ > $BASE_DIR/repo/dists/anal/main/binary-amd64/Packages
cat $BASE_DIR/repo/dists/anal/main/binary-amd64/Packages | gzip -9 > $BASE_DIR/repo/dists/anal/main/binary-amd64/Packages.gz

# make Release
cd $BASE_DIR/repo/dists/anal/
$BASE_DIR/scripts/generate-release.sh > Release
